...
public class AuthorizationFilterCUser implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (cookieValue != null) {
            try {
                ...
                if ("normal".equals(userSession.getRole()) || "admin".equals(userSession.getRole()) || "client".equals(userSession.getRole())) {
                    chain.doFilter(request, response);
                    return;
                } else {
